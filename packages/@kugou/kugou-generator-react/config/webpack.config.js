...
module.exports = function(webpackEnv) {
  ...
  const extraEnv = {
    DEVTOOL_HOST: process.env.DEVTOOL_HOST || urls.lanUrlForConfig,
    DEVTOOL_PORT: process.env.DEVTOOL_PORT || 8097
  }
  ...
  return {
    ...
    plugins: [
      ...
      new InterpolateHtmlPlugin(HtmlWebpackPlugin, { ...env.raw, ...extraEnv }),
      ...
      new webpack.EnvironmentPlugin(extraEnv),
